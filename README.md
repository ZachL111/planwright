...
planwright is a SQL project for databases. It focuses on this technical goal: Validate indexing choices with sqlite3 fixtures and plan expectations.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 179, risk penalty 5, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
