"""Regression checks for the planwright casebook."""
...
from casebook.harness import assert_expected, planwright_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(planwright_summary(), assert_expected())
