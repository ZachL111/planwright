...
`planwright` is centered on databases work in SQL. The technical target is: Validate indexing choices with sqlite3 fixtures and plan expectations.
...
The score is deterministic. The current threshold is 179. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 6.
